...
import { Character, CharacterStatus, Genders, ResourceRef, FilterAction } from '../../types';
        ...
        <div className={styles.copy}>
          {loading ? (
            ...
            <>
              ...
              <Status status={status} onFilter={onFilter} />
              <Attributes
                tags={{
                  species,
                  type,
                  gender: gender && gender !== Genders.Unknown ? gender : null,
                }}
                onFilter={onFilter}
              />
              <Text type='secondary'>Origin Location: </Text>
              <LocationLink {...(origin as ResourceRef)} />
              <br />
              <Text type='secondary'>Last Known Location: </Text>
              <LocationLink {...(location as ResourceRef)} />
              <br />
              <br />
              <EpisodeList
                episodes={episode}
                limit={asProfile ? 0 : 2}
                moreHref={`/characters/${id}`}
              />
            </>
          )}
        </div>
